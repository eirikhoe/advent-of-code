...
def main():
    ...
    print("Part 1")
    print(
        f"Bot number {bot_nr} is responsible for comparing value-{first_chip} and value-{second_chip} microchips"
    )
    print()
    ...
    print(
        f"If you multiply together the values of one chip in each of outputs 0, 1, and 2 you get {product}"
    )
