...
def len_decompressed(text,version=1):
    ...
    if m is None:
        ...
        if version == 1:
            ...
            res += n_repetitions*len_decompressed(text[span[1]:(span[1]+n_chars)],version) 
        return res
...
def main():
    ...
    print("Part 2")
    print(f"The decompressed text version two has length {len_decompressed(data,version=2)}")
